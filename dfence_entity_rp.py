    ...
    "description":#
      ...
      "scripts":#
        ...
        "pre_animation":[
          ...
          "variable.look_at_entity = query.distance_from_camera < 2.5 && Math.abs(Math.abs(query.rotation_to_camera(1) - query.camera_rotation(1)) - 180) < 20 && Math.abs(query.rotation_to_camera(0) + query.camera_rotation(0)) < 20;"
        ]
      ##,
      "animations":#
